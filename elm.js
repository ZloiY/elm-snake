...
var $author$project$Snake$Pending = {$: 'Pending'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Snake$init = function (_v0) {
	return _Utils_Tuple2($author$project$Snake$Pending, $elm$core$Platform$Cmd$none);
};
...
var $author$project$Snake$KeyPressed = function (a) {
	return {$: 'KeyPressed', a: a};
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Snake$Down = {$: 'Down'};
var $author$project$Snake$Left = {$: 'Left'};
var $author$project$Snake$Other = {$: 'Other'};
var $author$project$Snake$Right = {$: 'Right'};
var $author$project$Snake$Spacebar = {$: 'Spacebar'};
var $author$project$Snake$Up = {$: 'Up'};
var $author$project$Snake$toDirection = function (string) {
	switch (string) {
		case 'd':
			return $author$project$Snake$Left;
		case 'a':
			return $author$project$Snake$Right;
		case 'w':
			return $author$project$Snake$Up;
		case 's':
			return $author$project$Snake$Down;
		case ' ':
			return $author$project$Snake$Spacebar;
		default:
			return $author$project$Snake$Other;
	}
};
var $author$project$Snake$keyDecoder = A2(
	$elm$json$Json$Decode$map,
	function (key) {
		return $author$project$Snake$KeyPressed(key);
	},
	A2(
		$elm$json$Json$Decode$map,
		$author$project$Snake$toDirection,
...
var $author$project$Snake$subscriptions = function (game) {
	if (game.$ === 'Pending') {
		return $elm$browser$Browser$Events$onKeyPress($author$project$Snake$keyDecoder);
	} else {
		var speed = game.d;
		return $elm$core$Platform$Sub$batch(
			_List_fromArray(
				[
					A2($elm$time$Time$every, speed, $author$project$Snake$Tick),
					$elm$browser$Browser$Events$onKeyPress($author$project$Snake$keyDecoder)
				]));
	}
};
var $author$project$Snake$SpawnFood = function (a) {
	return {$: 'SpawnFood', a: a};
};
var $author$project$Snake$Started = F4(
	function (a, b, c, d) {
		return {$: 'Started', a: a, b: b, c: c, d: d};
	});
...
var $author$project$Snake$initGameSpeed = 500;
var $author$project$Snake$canvasHeight = 700;
var $author$project$Snake$canvasWidth = 700;
var $author$project$Snake$initHeadPos = _Utils_Tuple2(($author$project$Snake$canvasWidth / 2) | 0, ($author$project$Snake$canvasHeight / 2) | 0);
var $author$project$Snake$bodyPartLength = 20;
var $author$project$Snake$bodyPartsOffset = 2;
var $author$project$Snake$nextPosition = F2(
	function (direction, _v0) {
		var posX = _v0.a;
		var posY = _v0.b;
		switch (direction.$) {
			case 'Left':
				return _Utils_Tuple2((posX + $author$project$Snake$bodyPartLength) + $author$project$Snake$bodyPartsOffset, posY);
			case 'Right':
				return _Utils_Tuple2(posX - ($author$project$Snake$bodyPartLength + $author$project$Snake$bodyPartsOffset), posY);
			case 'Up':
				return _Utils_Tuple2(posX, posY - ($author$project$Snake$bodyPartLength + $author$project$Snake$bodyPartsOffset));
			case 'Down':
				return _Utils_Tuple2(posX, (posY + $author$project$Snake$bodyPartLength) + $author$project$Snake$bodyPartsOffset);
			default:
...
var $author$project$Snake$initTailList = _List_fromArray(
	[
		A2($author$project$Snake$nextPosition, $author$project$Snake$Left, $author$project$Snake$initHeadPos),
		A2(
		$author$project$Snake$nextPosition,
		$author$project$Snake$Left,
		A2($author$project$Snake$nextPosition, $author$project$Snake$Left, $author$project$Snake$initHeadPos))
	]);
var $author$project$Snake$initSnake = {head: $author$project$Snake$initHeadPos, length: 3, movingDirection: $author$project$Snake$Right, tail: $author$project$Snake$initTailList};
...
var $author$project$Snake$isGameOver = F2(
	function (head, tail) {
		return A2(
			$elm$core$List$any,
			$elm$core$Basics$eq(head),
			tail) || ((head.a < 0) || ((head.b < 0) || ((_Utils_cmp(head.a, $author$project$Snake$canvasWidth) > 0) || (_Utils_cmp(head.b, $author$project$Snake$canvasHeight) > 0))));
	});
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $author$project$Snake$isOverlap = F2(
	function (_v0, food) {
		var posX = _v0.a;
		var posY = _v0.b;
		if (food.a.$ === 'Just') {
			...
			var foodX = _v2.a;
			var foodY = _v2.b;
			var foodRadius = food.b;
			var _v3 = _Utils_Tuple2(foodX - posX, foodY - posY);
			var xd = _v3.a;
			var yd = _v3.b;
			var distance = $elm$core$Basics$sqrt((xd * xd) + (yd * yd));
			return _Utils_cmp(distance, foodRadius * 2) < 1;
		} else {
			var _v4 = food.a;
			return false;
		}
...
var $author$project$Snake$nextTailPosition = F2(
	function (prevHead, list) {
		return A2(
			$elm$core$List$cons,
			prevHead,
			A2(
...
var $author$project$Snake$rollCoordinate = A2($elm$random$Random$int, $author$project$Snake$bodyPartLength, $author$project$Snake$canvasWidth);
var $author$project$Snake$foodMaxScore = 20;
var $author$project$Snake$foodMinScore = 10;
var $author$project$Snake$rollScore = A2($elm$random$Random$int, $author$project$Snake$foodMinScore, $author$project$Snake$foodMaxScore);
var $author$project$Snake$spawnFood = A2(
	$elm$random$Random$pair,
	A2($elm$random$Random$pair, $author$project$Snake$rollCoordinate, $author$project$Snake$rollCoordinate),
	$author$project$Snake$rollScore);
var $author$project$Snake$update = F2(
	function (msg, game) {
		if (game.$ === 'Pending') {
			if ((msg.$ === 'KeyPressed') && (msg.a.$ === 'Spacebar')) {
				var _v2 = msg.a;
				return _Utils_Tuple2(
					A4(
						$author$project$Snake$Started,
						$author$project$Snake$initSnake,
						_Utils_Tuple2($elm$core$Maybe$Nothing, 0),
						0,
						$author$project$Snake$initGameSpeed),
			...
			switch (msg.$) {
				case 'Tick':
					return _Utils_eq(food.a, $elm$core$Maybe$Nothing) ? _Utils_Tuple2(
						A4(
							$author$project$Snake$Started,
							_Utils_update(
								snake,
								{
									head: A2($author$project$Snake$nextPosition, snake.movingDirection, snake.head),
									tail: A2($author$project$Snake$nextTailPosition, snake.head, snake.tail)
								}),
							_Utils_Tuple2($elm$core$Maybe$Nothing, 0),
							score,
							speed),
						A2($elm$random$Random$generate, $author$project$Snake$SpawnFood, $author$project$Snake$spawnFood)) : (A2($author$project$Snake$isOverlap, snake.head, food) ? _Utils_Tuple2(
						A4(
							$author$project$Snake$Started,
							_Utils_update(
								snake,
								{
									...
									tail: A2($elm$core$List$cons, snake.head, snake.tail)
								}),
							_Utils_Tuple2($elm$core$Maybe$Nothing, 0),
							score + food.b,
							speed - 20),
						$elm$core$Platform$Cmd$none) : (A2($author$project$Snake$isGameOver, snake.head, snake.tail) ? _Utils_Tuple2($author$project$Snake$Pending, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						A4(
							$author$project$Snake$Started,
							_Utils_update(
								snake,
				...
				case 'KeyPressed':
					var direction = msg.a;
					return ((_Utils_eq(direction, $author$project$Snake$Right) || _Utils_eq(direction, $author$project$Snake$Left)) && ((_Utils_eq(snake.movingDirection, $author$project$Snake$Right) || _Utils_eq(snake.movingDirection, $author$project$Snake$Left)) && (!_Utils_eq(snake.movingDirection, direction)))) ? _Utils_Tuple2(game, $elm$core$Platform$Cmd$none) : (((_Utils_eq(direction, $author$project$Snake$Up) || _Utils_eq(direction, $author$project$Snake$Down)) && ((_Utils_eq(snake.movingDirection, $author$project$Snake$Up) || _Utils_eq(snake.movingDirection, $author$project$Snake$Down)) && (!_Utils_eq(snake.movingDirection, direction)))) ? _Utils_Tuple2(game, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						A4(
							$author$project$Snake$Started,
							_Utils_update(
								snake,
...
var $author$project$Snake$renderFood = function (_v0) {
	var position = _v0.a;
	var score = _v0.b;
	if (position.$ === 'Just') {
		var _v2 = position.a;
...
var $author$project$Snake$renderSquare = function (_v0) {
	var posX = _v0.a;
	var posY = _v0.b;
	return A2(
		$joakin$elm_canvas$Canvas$shapes,
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(posX, posY),
				$author$project$Snake$bodyPartLength,
				$author$project$Snake$bodyPartLength)
			]));
};
var $author$project$Snake$renderSnake = function (_v0) {
	var head = _v0.head;
	var tail = _v0.tail;
	return A2(
		$elm$core$List$cons,
		$author$project$Snake$renderSquare(head),
		A2(
			$elm$core$List$map,
			function (tailNode) {
				return $author$project$Snake$renderSquare(tailNode);
			},
			tail));
};
...
var $author$project$Snake$view = function (game) {
	if (game.$ === 'Pending') {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					'width',
					$elm$core$String$fromInt($author$project$Snake$canvasWidth) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromInt($author$project$Snake$canvasHeight) + 'px'),
					A2($elm$html$Html$Attributes$style, 'text-align', 'center'),
					A2($elm$html$Html$Attributes$style, 'background-color', 'lightgrey')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Use \'w\', \'a\', \'s\', \'d\' for your controls. Press spacebar to start')
				]));
	} else {
		var snake = game.a;
		var food = game.b;
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					'Score: ' + ($elm$core$String$fromInt(score) + (' Snake length: ' + $elm$core$String$fromInt(snake.length)))),
					A3(
					$joakin$elm_canvas$Canvas$toHtml,
					_Utils_Tuple2($author$project$Snake$canvasWidth, $author$project$Snake$canvasHeight),
					_List_Nil,
					A2(
						...
						_List_fromArray(
							[
								...
								_Utils_Tuple2(0, 0),
								$author$project$Snake$canvasWidth,
								$author$project$Snake$canvasHeight),
								A2(
								$joakin$elm_canvas$Canvas$shapes,
								_List_fromArray(
									[
								...
								$author$project$Snake$renderFood(food)
							]),
						$author$project$Snake$renderSnake(snake)))
				]));
	}
};
